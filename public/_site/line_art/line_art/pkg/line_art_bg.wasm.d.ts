...
export const closure75_externref_shim: (a: number, b: number, c: any) => void;
export const closure104_externref_shim: (a: number, b: number, c: any, d: number, e: any) => void;
export const closure102_externref_shim: (a: number, b: number, c: any, d: any) => void;

...
export class PitchDetector {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(PitchDetector.prototype);
        obj.__wbg_ptr = ptr;
        PitchDetectorFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
     ...
     */
    static new(sample_rate, fft_size, model_bytes) {
        const ptr0 = passArray8ToWasm0(model_bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.pitchdetector_new(sample_rate, fft_size, ptr0, len0);
        return PitchDetector.__wrap(ret);
    }
    /**
     * @param {Float32Array} audio_data
     * @returns {Float32Array}
     */
    put_pitch(audio_data) {
        const ptr0 = passArrayF32ToWasm0(audio_data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.pitchdetector_put_pitch(this.__wbg_ptr, ptr0, len0);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_2273c222ea658ab8 = function(arg0, arg1) {
